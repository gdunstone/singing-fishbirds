...
At the time of writing there are only **2** versions of **Singing FishBirds**, one is designed for networked use, and the other is designed for a standalone machine.

The networked version should be available in the [master git](https://github.com/stormaes/singing-fishbirds) with the standalone version available as a [branch](https://github.com/stormaes/singing-fishbirds/tree/local).
...
###Modes
	...
	ENTROPIC
	The fish are rendered as a series of random straight lines.I 
---
...
---
	...
	Note: At the time of writing this variable has not been extensively tested. I have no idea whether it works or not.
